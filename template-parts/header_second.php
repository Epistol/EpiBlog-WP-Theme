<div class="secondMenu  index-menu-icons" id="index-menu-icons">
    <div class="columns is-mobile is-multiline  is-paddingless is-marginless">
        ...
        <div class="column is-paddingless has-text-centered menu2" id="vuejs">
            <a href="<?php get_site_url() ?>?s=vuejs">
                <p class="marginless"><i class="fab fa-vuejs fa-2x"></i></p>
                <p class="marginless brand-name">VueJS</p>
            </a>
        </div>
        <div class="column is-paddingless has-text-centered menu2" id="wp">
        ...
        <div class="column is-paddingless has-text-centered menu2" id="code">
            <a href="<?php get_site_url() ?>?s=code">
                <p class="marginless"><i class="fas fa-code fa-2x"></i></p>
                <p class="marginless brand-name"> Code</p>
            </a>
        </div>
        <div class="column is-paddingless has-text-centered menu2" id="art">
